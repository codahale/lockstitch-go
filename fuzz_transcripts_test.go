...
func FuzzProtocolDivergence(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, data []byte) {
		...
		p1 := lockstitch.NewProtocol("divergence")
		p2 := lockstitch.NewProtocol("divergence")
...
func FuzzProtocolReversibility(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, data []byte) {
		...
		p1 := lockstitch.NewProtocol("reversibility")
		...
		p2 := lockstitch.NewProtocol("reversibility")
